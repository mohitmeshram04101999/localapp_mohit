...
class NotificationPermissionNotifier extends StateNotifier<bool>
{
  ...
  Future<void> getNotification(BuildContext context) async
  {
    ...
    logger.t("Statuas");
    NotificationSettings permissionStatus = await _fireBaseMessaging.getNotificationSettings();

    logger.t(permissionStatus.authorizationStatus);
    ...
    if(permissionStatus.authorizationStatus ==AuthorizationStatus.denied)
      {
        ...
        await showDialog(context: context,barrierDismissible: false, builder: (context)=>AlertDialog(
          content: Column(mainAxisSize: MainAxisSize.min,children: [
            ...
            Text("Plese provide Notification permission  provide Frome Settings",textAlign: TextAlign.center,),
            if(permissionStatus.authorizationStatus==AuthorizationStatus.denied)
    ...
    else if(permissionStatus.authorizationStatus == AuthorizationStatus.notDetermined)
      {
