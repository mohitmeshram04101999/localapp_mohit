...
import 'package:mooxy_pdf/cpu_bin_map_controller.dart';
...
class SpecialSchematicTabBar extends ConsumerStatefulWidget {
  const SpecialSchematicTabBar({super.key});

  @override
  ConsumerState createState() => _SpecialSchematicTabBarState();
}

class _SpecialSchematicTabBarState
    extends ConsumerState<SpecialSchematicTabBar> {
  final SpecialSchematicControllers _appControllers =
      SpecialSchematicControllers();
