...
class SpecialSchematicControllers {
  ...
  Future<SubBrandResponse> getAllSubBrandsByPBrand(String pBrandId) async {
    try {
      final response = await dio.request(
        '/api/getAllSubBrandBypBrand?pBrandId=$pBrandId&type=SPECIALSCHEMATIC&search=&page=1',
        options: Options(method: 'GET'),
      );
  ...
  Future<SubSubBrandResponse> getAllSubSubBrandsByPBrand(
      String pBrandId) async {
    try {
      final response = await dio.request(
        '/api/getAllSchematicPdfByBrandId/$pBrandId?page=1',
        options: Options(method: 'GET'),
      );
